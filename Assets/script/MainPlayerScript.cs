...
public class MainPlayerScript : NetworkBehaviour
{
    ...
    //position
    public NetworkVariable<int> postX = new NetworkVariable<int>(
        0,
    ...
    {
        Debug.Log("Massage = " + msg);
    }

    [ServerRpc]
    private void TestServerRpc(string msg, ServerRpcParams serverRpcParams)
    {
        Debug.Log("Massage = " + msg + "Test from id = " + serverRpcParams.Receive.SenderClientId);
    }
